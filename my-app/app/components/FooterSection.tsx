    ...
    <div className="bg-gray-100 pt-16 pb-8">
      ...
      <div className="bg-gray-900 text-white py-8 px-4">
        ...
        <div className="max-w-7xl mx-auto mt-4 text-center text-sm text-gray-400">
          ...
          <a href="#" className="text-green-500 underline">Datenschutzbestimmungen</a> zu.
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row sm:justify-between">
        ...
        <div className="w-full sm:w-auto">
          ...
          <button
            className="w-full flex justify-between items-center text-gray-700 font-bold py-4 sm:hidden"
          ...
          {isShopOpen && (
            <ul className="text-gray-600 space-y-2 sm:hidden">
        ...
        <div className="w-full sm:w-auto">
          ...
          {isStoreOpen && (
            <ul className="text-gray-600 space-y-2 sm:hidden">
              ...
              <li><a href="#" className="hover:underline">Behandlungsprozess</a></li>
        ...
        <div className="w-full sm:w-auto">
          ...
          {isLegalOpen && (
            <ul className="text-gray-600 space-y-2 sm:hidden">
              ...
              <li><a href="#" className="hover:underline">AGB Shop</a></li>
              <li><a href="#" className="hover:underline">AGB Store</a></li>
            </ul>
          )}
          {/* Larger Screens (static list) */}
          <div className="hidden sm:block">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col space-y-4 items-center text-gray-600">
        <div>
