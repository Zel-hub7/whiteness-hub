...
const UniqueTreatmentSection: React.FC = () => {
  return (
    <div>
      {/* Concept Weiss Section (This was previously the second section) */}
      <div className="bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white py-16 m-6 rounded-lg shadow-xl">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Title */}
          <h2 className="text-5xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">
            CONCEPT WEISS
          </h2>

          {/* Paragraph */}
          <p className="text-lg leading-relaxed text-gray-200 font-medium tracking-wide">
      ...
      {/* Unique Treatment Section (This was previously the first section) */}
          ...
          <div className="flex space-x-4">
            ...
            <div className="relative transform hover:scale-105 transition duration-300">
              <img
                ...
                className="rounded-lg shadow-2xl w-48 h-auto border-2 border-gray-200"
              />
              <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-2 py-1 rounded-lg shadow-lg">
                Before
              </p>
            </div>
            <div className="relative transform hover:scale-105 transition duration-300">
